...
source references, allowed source origins, and historical file hashes. It runs
without network access and makes no changes. This export does not include an
